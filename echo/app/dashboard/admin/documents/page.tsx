        ...
        <div className="h-screen overflow-auto bg-gray-50">
            <div className="min-h-full flex flex-col p-4 sm:p-6 lg:p-8">
                <div className="mb-6 sm:mb-8">
                    ...
                    <p className="text-sm text-gray-600 mt-1">View all uploaded documents</p>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
                    ...
                    {isLoading ? (
                        ...
                        <p className="text-sm text-gray-500 text-center py-8">No documents found. Upload files to see them here.</p>
                    ) : (
